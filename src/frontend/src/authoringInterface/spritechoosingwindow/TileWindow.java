...
public class TileWindow extends PopUpWindow {
    ...
    public TileWindow(Stage primaryStage, ObjectManager objectManager, OldSideView mySideView, Integer id, TreeItem item) {
        super(primaryStage);
